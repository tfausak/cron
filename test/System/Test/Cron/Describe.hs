    ...
    [ testGroup
      ...
      testGroup
        ...
        [ testCase "describes specific times - twenty four hour" $
          ...
          testGroup
            "describes times for lists of hours"
